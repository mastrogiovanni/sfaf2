...
<header>
  <nav class="bg-primary navbar navbar-dark navbar-expand-lg py-4"> 
      <div class="container"> <a class="fw-bold navbar-brand text-uppercase" href="#" target>SFAF</a>
          <a class="fw-bold navbar-brand text-uppercase" href="#" target></a> 
          ...
          <div class="collapse navbar-collapse " id="navbarNavDropdown-21"> 
              <ul class="ms-auto navbar-nav"> 
                  <li class="nav-item"> <a class="active nav-link px-lg-3 py-lg-4 text-uppercase" aria-current="page" href="#">Home</a> 
                  </li>                             
                  <li class="nav-item"> <a class="nav-link px-lg-3 py-lg-4 text-uppercase" href="#">About</a> 
                  </li>                             
                  <li class="nav-item"> <a class="nav-link px-lg-3 py-lg-4 text-uppercase" href="#">Features</a> 
                  </li>                             
                  <li class="nav-item dropdown"> <a class="dropdown-toggle nav-link px-lg-3 py-lg-4 text-uppercase" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                                     Services </a> 
                  ...
                  <li class="nav-item"> <a class="nav-link px-lg-3 py-lg-4 text-uppercase" href="#">Contact</a> 
                  </li>                             
              </ul>                         
  ...
  <div class="container">
      <div class="align-items-center row">
          <div class="col-lg-6 mb-5">
              <p class="h6 text-primary text-uppercase">SFAF</p>
              <h1 class="display-4 fw-bold mb-3 text-dark">Scuola di Formazione Animatori Familiari</h1>
              <p class="fw-light lead mb-4">o come diciamo noi... Famiglia di Famiglie!</p><a href="#" class="btn btn-primary">Prenota!</a>
          </div>
          <div class="col-lg-6">
              <div class=" bg-white mb-n5 p-3 shadow" style="position: relative;">
                  <img class="img-fluid w-100" alt="Hero image" width="640" height="800" src="https://www.cerchidonda.org/wp-content/uploads/2022/04/Copia-di-SFAF-2022-1.png"/>
              </div>
          </div>
      </div>
  </div>
...
<section class="pb-5 pt-5 text-secondary"> 
  <div class="container pb-5 pt-5"> 
      <div class="align-items-center mb-3 row"> 
          <div class="col-lg-7"> 
              <h2 class="h6 mb-1 text-primary">Services</h2> 
              <h3 class="fw-bold h2 mb-1 text-dark">We are committed to protecting our clients</h3>
      ...
      <div class="row"> 
          <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
              <div class="bg-light d-block pb-5 ps-4 pe-4 pt-5 shadow">
                  ...
                  <h4 class="fw-bold h5 text-dark">Data Protection</h4> 
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p><a href="#" class="text-decoration-none">Learn More</a> 
              </div>                         
          </div>                     
          <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
              <div class="bg-light d-block mb-sm-n5 mt-sm-5 pb-5 ps-4 pe-4 pt-5 shadow">
                  ...
                  <h4 class="fw-bold h5 text-dark">Intellectual Property</h4> 
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p><a href="#" class="text-decoration-none">Learn More</a> 
              </div>                         
          </div>                     
          <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
              <div class="bg-light d-block pb-5 ps-4 pe-4 pt-5 shadow">
                  ...
                  <h4 class="fw-bold h5 text-dark">Tax Consultation</h4> 
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p><a href="#" class="text-decoration-none">Learn More</a> 
              </div>                         
          </div>                     
          <div class="col-sm-6 col-xl-3 pb-3 pt-3"> 
              <div class="bg-light d-block mt-sm-5 pb-5 ps-4 pe-4 pt-5 shadow">
                  ...
                  <h4 class="fw-bold h5 text-dark">Consumer Protection</h4> 
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p><a href="#" class="text-decoration-none">Learn More</a> 
              </div>                         
          </div>                     
      </div>                 
...
<section> 
  <div class="container">
      <div class="bg-light p-4 ps-lg-5 pe-lg-5 text-secondary">
          <div class="align-items-center row"> 
              <div class="col-lg-7 pb-2 pt-2"> 
                  <h2 class="h5 text-muted text-uppercase">Get In Touch</h2> 
                  <h3 class="fw-bold h1 mb-4 text-dark">Maximize the efficiency and quality of your company.</h3> <a href="#" class="btn btn-primary">Let&apos;s Talk</a> 
              </div>
              <div class="col-lg-5 pb-2 pt-2"> 
                  <img src="https://images.unsplash.com/photo-1444653614773-995cb1ef9efa?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDI2NXx8cHJvZmVzc2lvbmFsfGVufDB8fHw&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=600&h=400&fit=crop" class="img-fluid w-100" alt="CTA image" width="600" height="400"/> 
              </div>                         
          </div>
      </div>                 
  </div>             
  ...
  <div class="container">
      <div class="bg-primary pb-5 ps-4 pe-4 pt-5 text-center text-white">
          <div class="col-xl-10 mx-auto pb-4 pt-4 text-white">
              <h2 class="h5">Our Number Counts</h2>
              <h3 class="fw-bold h2 mb-4">Most awarded law firm in the city</h3>
              <div class="justify-content-center row"> 
                  <div class="col-lg-3 col-sm-6 pb-3 pt-3">
                      <div class="pb-5 ps-3 pe-3 pt-5">
                          ...
                          <p class="mb-0">Qualified Lawyers</p>
                      </div>                                 
                  </div>
                  <div class="col-lg-3 col-sm-6 pb-3 pt-3">
                      <div class="pb-5 ps-3 pe-3 pt-5">
              ...
              <div id="carousel2" class="carousel slide" data-bs-ride="carousel"> 
                  <div class="carousel-inner"> 
                      <div class="carousel-item active"> 
                          ...
                          <div class=""> <span>I.P Freely - </span> <span class="text-primary">ACME Gizmo LLC</span> 
                          </div>                                     
                      </div>                                 
...
<section class="bg-light pb-5 pt-5 text-secondary">
  <div class="container pb-4 pt-4"> 
      <h2 class="fw-bold mb-4 text-dark">Latest Articles</h2>
      <div class="justify-content-center row"> 
          <div class="col-lg-4 col-md-6 pb-3 pt-3"> 
              <div class="bg-white d-flex flex-column h-100"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1508672019048-805c876b67e2?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDJ8fHRyYXZlbHxlbnwwfHx8&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=700&h=480&fit=crop" class="img-fluid w-100" alt="Blog image" width="700" height="480"/></a>
                  <div class="p-3">
                      <div class="fw-bold mb-2 text-primary"><a href="#" class="text-decoration-none">Travel</a>, <a href="#" class="text-decoration-none">Lifestyle</a>
                      </div><a href="#" class="link-dark text-decoration-none"><h3 class="h5 mb-0">Relaxing and observing the mountain reflection in a lake</h3></a>
                  </div>
                  <div class="align-items-center border-top d-flex justify-content-between mt-auto p-3 small"><a href="#" class="align-items-center d-flex link-dark text-decoration-none"><img src="https://images.unsplash.com/photo-1537151625747-768eb6cf92b2?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDE5fHxkb2d8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=400&h=400&fit=crop" class="me-2 rounded-circle" width="48" height="48" alt="Author image"/><div>
                              <h4 class="h6 mb-0">Dianne Russell</h4>
          ...
          <div class="col-lg-4 col-md-6 pb-3 pt-3"> 
              <div class="bg-white d-flex flex-column h-100"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1499363536502-87642509e31b?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDE2fHx0cmF2ZWx8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=700&h=480&fit=crop" class="img-fluid w-100" alt="Blog image" width="700" height="480"/></a>
                  <div class="p-3">
                      <div class="fw-bold mb-2 text-primary"><a href="#" class="text-decoration-none">Travel</a>, <a href="#" class="text-decoration-none">Lifestyle</a>
                      </div><a href="#" class="link-dark text-decoration-none"><h3 class="h5 mb-0">Where to grow your business as a photographer?</h3></a>
                  </div>
                  <div class="align-items-center border-top d-flex justify-content-between mt-auto p-3 small"><a href="#" class="align-items-center d-flex link-dark text-decoration-none"><img src="https://images.unsplash.com/photo-1574158622682-e40e69881006?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDd8fGNhdHxlbnwwfHx8&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=400&h=400&fit=crop" class="me-2 rounded-circle" width="48" height="48" alt="Author image"/><div>
                              <h4 class="h6 mb-0">Kathryn Murphy</h4>
                              <p class="mb-0 text-secondary">10 August 2020</p>
          ...
          <div class="col-lg-4 col-md-6 pb-3 pt-3"> 
              <div class="bg-white d-flex flex-column h-100"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1471506480208-91b3a4cc78be?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDUyfHx0cmF2ZWx8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=700&h=480&fit=crop" class="img-fluid w-100" alt="Blog image" width="700" height="480"/></a>
                  <div class="p-3">
                      <div class="fw-bold mb-2 text-primary"><a href="#" class="text-decoration-none">Travel</a>, <a href="#" class="text-decoration-none">Lifestyle</a>
                      </div><a href="#" class="link-dark text-decoration-none"><h3 class="h5 mb-0">How to notice colors when cycling over a mountain pass?</h3></a>
                  </div>
                  <div class="align-items-center border-top d-flex justify-content-between mt-auto p-3 small"><a href="#" class="align-items-center d-flex link-dark text-decoration-none"><img src="https://images.unsplash.com/photo-1517101724602-c257fe568157?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDZ8fHBhcnJvdHxlbnwwfHx8&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=400&h=400&fit=crop" class="me-2 rounded-circle" width="48" height="48" alt="Author image"/><div>
                              <h4 class="h6 mb-0">Darrell Steward</h4>
                              <p class="mb-0 text-secondary">10 August 2020</p>
  ...
  <div class="container  pb-5 pt-5"> 
      <div class="align-items-center row"> 
          <div class="col-lg-7 ms-auto me-auto"> 
              <h2 class="fw-bold text-dark">Need a professional legal advice?</h2>
              <p class="fw-light mb-4">Get one free consultation from our legal experts</p><a href="#" class="btn btn-primary">Request Now</a> 
          </div>                     
      </div>                 
  </div>             
</section>
